...
![CI/CD Pipeline](https://github.com/Maximo1289/devops-TP06/actions/workflows/cicd.yml/badge.svg)
...
| build-push | main y develop|dockerbuildx, push a Docker Hub|
| deploy| solo main| SSH al servidor, composepull + up |
...
pytesttests/ -v --cov=. --cov-report=term-missing
